    ...
    function format (row) {
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p><strong>CUSTOMER:</strong> ${displayPair(row.customer_code, row.customer_name)}</p>
                ...
                <p><strong>PRODUCT:</strong> ${displayPair(row.product_code, row.product_name)}</p>
            ...
            <div class="col-6">
                ...
                <p><strong>CUSTOMER P/O No:</strong> ${displayValue(row.order_no)}</p>
                <p><strong>S/O ORDER:</strong> ${displayValue(row.so_no)}</p>
                ...
                <p><strong>ORDER QUANTITY:</strong> ${displayUnit(row.order_quantity, 'KG')}</p>
                ...
                for (var i = 0; i < row.weights.length; i++) {
                    ...
                    returnString += `
                        <tr>
                            ...
                            <td>${displayValue(weights[i].product_code)}</td>
                            <td>${displayValue(weights[i].product_name)}</td>
