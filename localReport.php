...
if (!hasModulePermission('Reports', 'Local', ['view_all_companies'])) {
...
$plantName = '-';
$plantCode = '-';
if (!hasModulePermission('Reports', 'Local', ['view_all_plants'])) {
                                        ...
                                        <div class="card-body">
                                            <form action="javascript:void(0);">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3" <?= !hasModulePermission('Reports', 'Local', ['view_all_companies']) ? "style='display:none'" : '' ?>>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="card-header" style="background-color: #405189;">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Reports', 'Local', ['export'])): ?>
