...
<head>
    <title><?=$languageArray['permissions_code'][$language]?> | Synctronix - Weighing System</title>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="flex-shrink-0">
                                                    ...
                                                    <button type="button" id="multiDelete" class="btn btn-warning waves-effect waves-light">
                                                        ...
                                                        <?=$languageArray['delete_permission_code'][$language]?>
                                                    </button>
                                                    <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?=$languageArray['add_permission_code'][$language]?></h5>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <div class="row">
                                        <label for="permissionName" class="col-sm-4 col-form-label"><?=$languageArray['permission_name_code'][$language]?> *</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="permissionName" name="permissionName" placeholder="<?=$languageArray['permission_name_code'][$language]?>" required>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="row">
                                        <label class="col-sm-4 col-form-label"><?=$languageArray['applicable_module_code'][$language]?></label>
                                        <div class="col-sm-8">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="modulesAll" name="modulesAll" value="All">
                                                <label class="form-check-label" for="modulesAll"><strong><?=$languageArray['all_modules_code'][$language]?></strong></label>
                                            </div>
