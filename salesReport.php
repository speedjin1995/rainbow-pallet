...
if (!hasModulePermission('Reports', 'Sales', ['view_all_companies'])) {
...
$plantName = '-';
$plantCode = '-';
if (!hasModulePermission('Reports', 'Sales', ['view_all_plants'])) {
                                        ...
                                        <div class="card-body">
                                            <form action="javascript:void(0);">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3" <?= !hasModulePermission('Reports', 'Sales', ['view_all_companies']) ? "style='display:none'" : '' ?>>
                                                        <div class="mb-3">
