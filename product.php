...
<?php
    if (!hasModulePermission('Master Data', 'Products', ['view'])){
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Products', ['download_template'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Products', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Products', ['cancelled'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Products', ['create'])): ?>
                    ...
                    { 
                        ...
                        render: function ( data, type, row ) {
                            if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Products'] && ['edit', 'cancelled'].some(p => permissions['Master Data']['Products'].includes(p)))) {
                                ...
                                if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Products'] && permissions['Master Data']['Products'].includes('edit'))) {
                                    buttons += `
                                            <li>
                                ...
                                if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Products'] && permissions['Master Data']['Products'].includes('cancelled'))) {
                                    buttons += `
                                            <li>
