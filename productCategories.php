                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form role="form" id="productCategoryForm" class="needs-validation" novalidate autocomplete="off">
                                                                ...
                                                                <div class="card bg-light">
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="categoryName" class="col-sm-4 col-form-label"><?=$languageArray['category_name_code'][$language] ?? 'Category Name'?> <span class="text-danger">*</span></label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="categoryName" name="categoryName" placeholder="<?=$languageArray['category_name_code'][$language] ?? 'Category Name'?>" required>
                                                                                        <div class="invalid-feedback">
                                                                                            <?=$languageArray['please_fill_in_the_field_code'][$language] ?? 'Please fill in the field'?>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="postToSql" class="col-sm-4 col-form-label"><?=$languageArray['post_to_sql_code'][$language] ?? 'Post to SQL'?> <span class="text-danger">*</span></label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="postToSql" class="col-sm-4 col-form-label"><?=$languageArray['transaction_status_code'][$language] ?? 'Transaction Status'?> <span class="text-danger">*</span></label>
                                                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-success" id="submitProductCategory"><?=$languageArray['submit_code'][$language] ?? 'Submit'?></button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-success" id="uploadProductCategories"><?=$languageArray['submit_code'][$language] ?? 'Submit'?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                ...
                                                                <a href="template/Product_Category_Template.xlsx" download>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Product Category', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Product Category', ['cancelled'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Product Category', ['create'])): ?>
                                                                <button type="button" id="addProductCategory" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addModal">
                                                    ...
                                                    <div class="card-body">
                                                        <table id="productCategoryTable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                                                            <thead>
                                                                <tr>
...
$(function () {
    ...
    $('#uploadProductCategories').on('click', function(){
        $('#spinnerLoading').show();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (obj.status === 'success') {
                    ...
                    toastr["success"](obj.message, "Success:");
                    $('#productCategoryTable').DataTable().ajax.reload(null, false);
                }
                else if (obj.status === 'failed') {
                    $('#spinnerLoading').hide();
                    toastr["error"](obj.message, "Failed:");
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        $("#productCategoryTable tbody input[type='checkbox']").each(function () {
            if (this.checked) {
