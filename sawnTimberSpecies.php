...
<?php
    if (!hasModulePermission('Master Data', 'Sawn Timber Species', ['view'])){
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Sawn Timber Species', ['download_template'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sawn Timber Species', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sawn Timber Species', ['cancelled'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sawn Timber Species', ['create'])): ?>
    ...
    table = $("#speciesTable").DataTable({
        ...
        'columns': [
            ...
            { 
                data: 'id',
                render: function ( data, type, row ) {
                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sawn Timber Species'] && ['edit', 'cancelled'].some(p => permissions['Master Data']['Sawn Timber Species'].includes(p)))) {
                        var buttons = `
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sawn Timber Species'] && permissions['Master Data']['Sawn Timber Species'].includes('edit'))) {
                            buttons += `
                                    <li>
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sawn Timber Species'] && permissions['Master Data']['Sawn Timber Species'].includes('cancelled'))) {
                            buttons += `
                                    <li>
