...
if(!empty($_POST['paymentTerm']) && $_POST['paymentTerm'] != null && $_POST['paymentTerm'] != '' && $_POST['paymentTerm'] != '-'){
...
if(!empty($_POST['paymentTermPeriod']) && $_POST['paymentTermPeriod'] != null && $_POST['paymentTermPeriod'] != '' && $_POST['paymentTermPeriod'] != '-'){
