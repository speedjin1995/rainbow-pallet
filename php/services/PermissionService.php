...
class PermissionService extends BaseService {
    ...
    public function insertDefaults() {
        ...
        $defaultPermissions = [
            ...
            ['name' => 'create', 'modules' => [
                ['Companies', 'Master Data'], ['Customer', 'Master Data'], ['Destination', 'Master Data'],
                ['Product Category', 'Master Data'], ['Units', 'Master Data'], ['Items', 'Master Data'],
                ['Supplier', 'Master Data'], ['Vehicles', 'Master Data'], ['Plant', 'Master Data'],
                ['Locations', 'Master Data'], ['Translation', 'Master Data'], ['PV Items', 'Master Data'],
                ['Projects', 'Master Data'], ['Modules', 'User Management'], ['Permission', 'User Management'],
                ['Role', 'User Management'], ['User Setup', 'User Management'],
                ['Sales', 'Weighing'], ['Purchase', 'Weighing'], ['Port', 'Weighing'], ['Miscellaneous', 'Weighing'],
                ['Normal Type', 'Weighing'], ['Container Type', 'Weighing'],
                ['Empty Container Type', 'Weighing'], ['Different Container Type', 'Weighing'],
            ...
            ['name' => 'print', 'modules' => [
                ['Sales', 'Reports'], ['Purchase', 'Reports'], ['Port', 'Reports'], ['Miscellaneous', 'Reports'],
                ['Sales', 'Weighing'], ['Purchase', 'Weighing'], ['Port', 'Weighing'], ['Miscellaneous', 'Weighing'],
            ]],
            ['name' => 'view_all_plants', 'modules' => [
                ['Delivery Order', 'Accounting'], ['Goods Received', 'Accounting'],
                ['Sales', 'Reports'], ['Purchase', 'Reports'], ['Port', 'Reports'], ['Miscellaneous', 'Reports'],
                ['Sales', 'Weighing'], ['Purchase', 'Weighing'], ['Port', 'Weighing'], ['Miscellaneous', 'Weighing'],
                ['Sawn Timber', 'Sawn Timber'],
            ]],
            ['name' => 'download_template', 'modules' => [
                ...
                ['Product Category', 'Master Data'], ['Units', 'Master Data'], ['Items', 'Master Data'],
                ['Supplier', 'Master Data'], ['Vehicles', 'Master Data'], ['Plant', 'Master Data'],
                ['Locations', 'Master Data'], ['PV Items', 'Master Data'], ['Projects', 'Master Data'],
            ...
            ['name' => 'export', 'modules' => [
                ['Delivery Order', 'Accounting'], ['Goods Received', 'Accounting'],
                ['Audit Log', 'Reports'], ['Api Log', 'Reports'],
                ['Sales', 'Reports'], ['Purchase', 'Reports'], ['Port', 'Reports'], ['Miscellaneous', 'Reports'],
                ['Sawn Timber', 'Sawn Timber'],
            ]],
            ...
            ['name' => 'include_price', 'modules' => [
                ['Audit Log', 'Reports'], ['Delivery Order', 'Accounting'], ['Goods Received', 'Accounting'],
            ]],
