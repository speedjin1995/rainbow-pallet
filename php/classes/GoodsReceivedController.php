...
require_once __DIR__ . '/../services/GoodsReceivedService.php';

class GoodsReceivedController extends BaseController {
    protected $table = 'Weight';
    private $service;

    public function __construct($db) {
        parent::__construct($db);
        $this->service = new GoodsReceivedService($db, $this->username);
    }
    ...
    public function handleFilter() {
        ...
        try {
            ...
            error_log('GoodsReceived filter: ' . $e->getMessage());
    ...
    public function handleExport() {
        ...
        try {
            ...
            error_log('GoodsReceived export: ' . $e->getMessage());
            $this->failed('Something went wrong');
        }
    ...
    public function handlePost() {
        ...
        try {
            ...
            error_log('GoodsReceived post: ' . $e->getMessage());
            $this->failed('Something went wrong');
        } catch (Exception $e) {
