...
if (!hasModulePermission('Reports', 'Purchase', ['view_all_companies'])) {
...
$plantName = '-';
$plantCode = '-';
if (!hasModulePermission('Reports', 'Purchase', ['view_all_plants'])) {
...
<div id="layout-wrapper">
                                        ...
                                        <div class="card-body">
                                            <form action="javascript:void(0);">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3" <?= !hasModulePermission('Reports', 'Purchase', ['view_all_companies']) ? "style='display:none'" : '' ?>>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="card-header" style="background-color: #405189;">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Reports', 'Purchase', ['export'])): ?>
    ...
    $(function () {
        ...
        */
        ...
        $('#exportExcel').on('click', function(){
            ...
            var url = "php/modules/report/index.php?action=exportExcel&file=weight" +
                ...
                "&rawMat=" + encodeURIComponent($('#rawMatSearch').val() || '') +
        ...
        /* Old modal click handler - Commented out
        $('#exportPdf').on('click', function(){
        ...
        */
        ...
        /* Old Excel modal form submit - Commented out
